...
namespace NetworkLayer
{
	...
	const int MaxClientRecvBufSize = 8192;
	const int MaxClientSendBufSize = 8192;

	const int MaxClientSockOptRecvBufSize = 10240;
	const int MaxClientSockOptSendBufSize = 10240;
