...
private:
	...
	bool BindRecv(stClientInfo* pClientInfo)
	{
		...
		pClientInfo->m_stRecvOverlappedEx.m_wsaBuf.buf = pClientInfo->m_stRecvOverlappedEx.m_RecvBuf;
	...
	bool SendMsg(stClientInfo* pClientInfo, char* pMsg, int nLen)
	{
		...
		//전송될 메세지를 복사
		CopyMemory(pClientInfo->m_stSendOverlappedEx.m_SendBuf, pMsg, nLen);


		//Overlapped I/O을 위해 각 정보를 셋팅해 준다.
		pClientInfo->m_stSendOverlappedEx.m_wsaBuf.len = nLen;
		pClientInfo->m_stSendOverlappedEx.m_wsaBuf.buf = pClientInfo->m_stSendOverlappedEx.m_SendBuf;
		pClientInfo->m_stSendOverlappedEx.m_eOperation = IOOperation::SEND;

		pClientInfo->m_stSendOverlappedEx.m_SendBuf[nLen] = NULL;
