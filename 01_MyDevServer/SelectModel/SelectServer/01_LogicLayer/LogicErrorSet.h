...
namespace LogicLayer
{
	...
	enum class LOGIC_ERROR_SET : short
	{
		...
		CLIENT_MGR_ID_DUPLICATION = 211,
		CLIENT_MGR_MAX_USER_COUNT = 212,
		CLIENT_MGR_INVALID_INDEX = 213,
		CLIENT_MGR_NOT_CONFIRM_USER = 214,
		CLIENT_MGR_REMOVE_INVALID_SESSION = 221,

		LOBBY_LIST_INVALID = 226,
